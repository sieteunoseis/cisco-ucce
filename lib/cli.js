...
program
  ...
  .version("1.0.0")
  .option("--format <fmt>", "Output format: table|json|toon|csv", "table")
  .option("--host <host>", "Override target host")
  .option("--username <user>", "Override username")
  .option("--password <pass>", "Override password")
  .option("--cluster <name>", "Use specific cluster")
